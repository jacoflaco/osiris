	...
	<div id='slide-wrapper' class='slide-wrapper'>
		<div class='slide-left'>
			<div class='slide-left-header-hotels'>
				<h3 class='slide-header'>everything<br>you want</h3>
    	...
    	$('#info1').css({'display': 'block'});
			...
			$('#slide-right').css({'background': 'url(images/information/big/one.jpg) no-repeat', 'background-size': 'cover', 'background-position': 'center'});
		});
    	...
    	$('#info1').css({'display': 'none'});
			...
			$('#info5').css({'display': 'none'});
			$('#info6').css({'display': 'none'});
			$('#slide-right').css({'background': 'url(images/information/big/two.jpg) no-repeat', 'background-size': 'cover', 'background-position': 'center'});
		});
    	...
    	$('#info1').css({'display': 'none'});
			...
			$('#info5').css({'display': 'none'});
			$('#info6').css({'display': 'none'});
			$('#slide-right').css({'background': 'url(images/information/big/three.jpg) no-repeat', 'background-size': 'cover', 'background-position': 'center'});
		});
    	...
    	$('#info1').css({'display': 'none'});
			...
			$('#info5').css({'display': 'none'});
			$('#info6').css({'display': 'none'});
			$('#slide-right').css({'background': 'url(images/information/big/four.jpg) no-repeat', 'background-size': 'cover', 'background-position': 'center'});
		});
    	...
    	$('#info1').css({'display': 'none'});
			...
			$('#info6').css({'display': 'none'});
			$('#slide-right').css({'background': 'url(images/information/big/five.jpg) no-repeat', 'background-size': 'cover', 'background-position': 'center'});
		});
    	...
    	$('#info1').css({'display': 'none'});
			...
			$('#info5').css({'display': 'block'});
			$('#info6').css({'display': 'none'});
			$('#slide-right').css({'background': 'url(images/information/big/six.jpg) no-repeat', 'background-size': 'cover', 'background-position': 'center'});
		});
	</script>
	</div>
</div>
