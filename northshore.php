...
<!--	<img class="banner-image" src="images/index/banner.jpg"/>-->
	<div class="headline">
		<h1 class="headline-text">north shore hawaii</h1> <!--puts padding between 'e' and 'x' -->
	</div>
</div>

<div class="section-wrapper">
	<h2 class="section-header">luxury in a sought-after setting</h2>
	...
	<div id='slide-wrapper' class='slide-wrapper'>
		...
		<div id='slide-right' class='slide-right'>
			<div id='info1' class='slide-info'>
				<h3 class='slide-info-header'>things to do at north shore<h3>
				<p class='slide-info-text'>A dazzling dinner show, a challenging game of golf, or a reinvigorating day at the spa — however you prefer to spend your vacation, there’s always a new activity to try at Osiris North Shore.</p>
			</div>
			<div id='info2' class='slide-info'>
				<h3 class='slide-info-header'>spa at north shore<h3>
			...
			<div id='info3' class='slide-info'>
				<h3 class='slide-info-header'>entertainment at north shore<h3>
			...
			<div id='info4' class='slide-info'>
				<h3 class='slide-info-header'>activities at north shore<h3>
			...
			<div id='info5' class='slide-info'>
				<h3 class='slide-info-header'>dining at north shore<h3>
