...
<!--	<img class="banner-image" src="images/index/banner.jpg"/>-->
	<div class="headline">
		<h1 class="headline-text">villingili island maldives</h1> <!--puts padding between 'e' and 'x' -->
	</div>
</div>

<div class="section-wrapper">
	<h2 class="section-header">a vacation destination like no other</h2>
	...
	<div id='slide-wrapper' class='slide-wrapper'>
		<div class='slide-left'>
			<div class='slide-left-header'>
				...
				<p class='slide-header-text'>Nestled into the Indian Ocean, Osiris Villingili is a tropical beach paradise. Miles of wooden pathways connect five resort hotels to an endless array of amenities: luxury spas, salons, and fitness centers; nightly entertainment; stunning pools; and activities for the whole family.</p>
			</div>
			<div class='slide-nav'>
		...
		<div id='slide-right' class='slide-right'>
			<div id='info1' class='slide-info'>
				<h3 class='slide-info-header'>things to do at villingili<h3>
				<p class='slide-info-text'>A dazzling dinner show, a challenging game of golf, or a reinvigorating day at the spa — however you prefer to spend your vacation, there’s always a new activity to try at Osiris Villingili.</p>
			</div>
			<div id='info2' class='slide-info'>
				<h3 class='slide-info-header'>spa at villingili<h3>
			...
			<div id='info3' class='slide-info'>
				<h3 class='slide-info-header'>entertainment at villingili<h3>
			...
			<div id='info4' class='slide-info'>
				<h3 class='slide-info-header'>activities at villingili<h3>
			...
			<div id='info5' class='slide-info'>
				<h3 class='slide-info-header'>dining at villingili<h3>
				<p class='slide-info-text'>The dining experience at North Shore allows our members to take a global culinary tour, all in one amazing destination. Mexican, Spanish, Italian, Asian, French, Continental, American, gourmet burgers — we offer cuisines for every palate.</p>
			</div>
		</div>
		<script>
