...
<!--	<img class="banner-image" src="images/index/banner.jpg"/>-->
	<div class="headline">
		<h1 class="headline-text">zermatt switzerland</h1> <!--puts padding between 'e' and 'x' -->
	</div>
</div>

<div class="section-wrapper">
	<h2 class="section-header">a different kind of paradise</h2>
	...
	<div id='slide-wrapper' class='slide-wrapper'>
		<div class='slide-left'>
			<div class='slide-left-header'>
				...
				<p class='slide-header-text'>Enter a vacation world like no other. Osiris Zermatt truly is an oasis of relaxation and luxury located where the european city meets the beautiful Alps.</p>
			</div>
			<div class='slide-nav'>
		...
		<div id='slide-right' class='slide-right'>
			<div id='info1' class='slide-info'>
				<h3 class='slide-info-header'>things to do at zermatt<h3>
				<p class='slide-info-text'>A dazzling dinner show, a challenging game of golf, or a reinvigorating day at the spa — however you prefer to spend your vacation, there’s always a new activity to try at Osiris Zermatt.</p>
			</div>
			<div id='info2' class='slide-info'>
				<h3 class='slide-info-header'>spa at zermatt<h3>
			...
			<div id='info3' class='slide-info'>
				<h3 class='slide-info-header'>entertainment at zermatt<h3>
			...
			<div id='info4' class='slide-info'>
				<h3 class='slide-info-header'>activities at zermatt<h3>
			...
			<div id='info5' class='slide-info'>
				<h3 class='slide-info-header'>dining at zermatt<h3>
				<p class='slide-info-text'>The dining experience at Zermatt allows our members to take a global culinary tour, all in one amazing destination. Mexican, Spanish, Italian, Asian, French, Continental, American, gourmet burgers — we offer cuisines for every palate.</p>
			</div>
		</div>
		<script>
